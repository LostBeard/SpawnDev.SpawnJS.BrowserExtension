...
namespace SpawnDev.SpawnJS.BrowserExtension.Services
{
    ...
    {
        private static SpawnJSRuntime _JS => SpawnJSRuntime.Instance;
        // chrome
        ...
        public BrowserExtensionService(SpawnJSRuntime js)
        {
            JS = js;
            Location = JS.Get<string>("location.href");
            LocationUri = new Uri(Location);
            // Get the base uri of the Blazor app
            BlazorBaseURI = js.AppBaseUri;
            // 
