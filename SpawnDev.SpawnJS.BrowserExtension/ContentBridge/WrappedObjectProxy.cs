...
namespace SpawnDev.SpawnJS.BrowserExtension
{
    ...
    /// </summary>
    public class WrappedObjectProxy : SpawnJSObject
    {
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public WrappedObjectProxy(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// <summary>
        /// Get WrappedObjectProxy from a SpawnJSObject
        /// </summary>
        /// <param name="_ref"></param>
        /// <returns></returns>
        public static WrappedObjectProxy GetWrappedObjectProxy(SpawnJSObject _ref) => _ref.JSRefCopy<WrappedObjectProxy>();
        /// <summary>
        /// Returns true if the Javascript object is a WrappedObjectProxy
        /// </summary>
        /// <param name="jsObject"></param>
        /// <returns></returns>
        public static bool IsWrappedObjectProxy(SpawnJSObject jsObject) => !string.IsNullOrEmpty(jsObject.JSRef!.Get<string?>("__wrappedObjectDispatcherId"));
        #endregion
    }
}
