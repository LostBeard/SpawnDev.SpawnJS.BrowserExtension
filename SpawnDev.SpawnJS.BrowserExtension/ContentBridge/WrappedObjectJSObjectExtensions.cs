namespace SpawnDev.SpawnJS.BrowserExtension
{
    ...
    {
        /// <summary>
        /// Returns true if the SpawnJSObject is a wrappedObject proxy
        /// </summary>
        ...
        /// <param name="_this"></param>
        /// <returns></returns>
        public static bool WrappedObjectRelease(this SpawnJSObject _this) => _this.JSRef!.Call<bool>("__wrappedObjectRelease");
        /// <summary>
