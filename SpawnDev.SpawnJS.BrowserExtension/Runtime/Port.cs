...
namespace SpawnDev.SpawnJS.BrowserExtension
{
    ...
    /// </summary>
    public class Port : SpawnJSObject
    {
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        public Port(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// </summary>
        public ActionEvent<SpawnJSObject> OnMessage { get => JSRef!.Get<ActionEvent<SpawnJSObject>>("onMessage"); set { } }
    }
}
