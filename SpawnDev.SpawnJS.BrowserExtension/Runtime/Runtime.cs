...
namespace SpawnDev.SpawnJS.BrowserExtension
{
    ...
    /// </summary>
    public class Runtime : SpawnJSObject
    {
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        public Runtime(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public SpawnJSObject GetManifest() => JSRef!.Call<SpawnJSObject>("getManifest");
        /// <summary>
        ...
        /// </summary>
        public FuncEvent<SpawnJSObject, MessageSender, Function?, bool> OnMessage { get => JSRef!.Get<FuncEvent<SpawnJSObject, MessageSender, Function?, bool>>("onMessage"); set { } }
        /// <summary>
        /// Fired when a message is sent from another extension. Cannot be used in a content script.
        /// To send a response synchronously, call sendResponse() before the listener function returns.<br/>
        /// To send a response asynchronously, keep a reference to the sendResponse() argument and return true from the listener function. You will then be able to call sendResponse() after the listener function has returned.<br/>
        /// </summary>
        public FuncEvent<SpawnJSObject, MessageSender, Function?, bool> OnMessageExternal { get => JSRef!.Get<FuncEvent<SpawnJSObject, MessageSender, Function?, bool>>("onMessageExternal"); set { } }
        /// <summary>
